...
// ==== add the leading "POST&" and then URLencode it all 
var hash_message_encoded = "POST&" + pctenc(hash_message); //func above
...
// send data
var data = {
  "uuid": "3979492f-88d3-4767-a205-a226526a1959",
  "pass":"password",
...
http.open('POST', final_url, false, http_auth_user, http_auth_pass);
