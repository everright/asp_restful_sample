...
// ==== add the leading "PUT&" and then URLencode it all 
var hash_message_encoded = "PUT&" + pctenc(hash_message); //func above
...
http.open('PUT', final_url, false, http_auth_user, http_auth_pass);
