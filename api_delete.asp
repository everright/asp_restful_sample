...
var base_url = "http://example.com/api/v1/user/3979492f-88d3-4767-a205-a226526a1959";
...
// ==== add the leading "DELETE&" and then URLencode it all 
var hash_message_encoded = "DELETE&" + pctenc(hash_message); //func above
...
http.open('DELETE', final_url, false, http_auth_user, http_auth_pass);
